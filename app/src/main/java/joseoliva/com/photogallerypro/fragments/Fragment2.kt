...
class Fragment2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewModel.imagentab2.observe(viewLifecycleOwner) {
            initRecyclerView(it)
        }

        fab.setOnClickListener {
            val intent = Intent(context, AddPictureActivity::class.java)
            intent.putExtra("codigotab", 2) //paso el codigotab, en este caso 2 para luego identificar las imagenes de cada tab
